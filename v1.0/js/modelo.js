...
function enviardados3() {
  ...
  if (
    document.fale.assunto.value == '' ||
    document.fale.assunto.value.length < 3
  ) {
  ...
  if (
    document.fale.mensagem.value == '' ||
    document.fale.mensagem.value.length < 10
  ) {
    alert(
      'Prencha campo menssagem corrtamente! Use caracteres com bom senso. Excesso de espaços em branco não serão permitidos.'
    );
